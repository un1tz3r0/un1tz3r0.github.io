      ...
      this.r = Math.abs(r);
		...
		subdivide(num, rotate, gapfn, recfn, filfn) {
			if((filfn == undefined) || filfn(this))
			{
				...
				{
					var cursubc = new Circle(this.x + Math.cos(subt * subi) * (this.r - subr), this.y + Math.sin(subt * subi) * (this.r - subr), subr, (this.a + (subi * subt)) * (90.0/Math.PI), this.g + 1, this, [subi, num],  [this, centc]);
					if(lastsubc != null) {
