		...
		subdivide(num, rotate, gapfn, recfn, filfn) {
			if((filfn == undefined) || filfn(this))
			{
				...
				for(let subi = 0; subi < num; subi++)
				{
					...
					var cursubc = new Circle(this.x + Math.cos(subt * subi) * (this.r - subr), this.y + Math.sin(subt * subi) * (this.r - subr), subr, 0*this.a + (subi * subt) * (360.0/Math.PI), this.g + 1, this, [subi, num],  [this, centc]);
					if(lastsubc != null) {
