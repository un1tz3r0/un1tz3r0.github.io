...
//const _Plane = exports.Polygon = exports.Vector = exports.Vertex = exports.CSG = void 0;
//export { _Plane as Plane };
import { Vector3, Matrix3, BufferGeometry, BufferAttribute, Matrix4, Mesh } from "three";
let CSG = (function() {
  function CSG() {
    this.polygons = [];
  }
  ...
  CSG.toMesh = function (csg, toMatrix, toMaterial) {
    ...
    var m = new Mesh(geom, toMaterial);
...
let Plane = (()=>{
  ...
  Plane.prototype.splitPolygon = function (
    polygon,
    coplanarFront,
    coplanarBack,
    front,
